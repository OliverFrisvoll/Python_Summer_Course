...
def currency_swap_2_3():
    NOK_EUR = 10.40
    text = input("Amount of money to exchange with EUR or NOK at the end: ").upper()
    ...
    if text.endswith("NOK"):
        ...
        print(" --- We currently do not support this currency, please try NOK or EUR --- ")
...
def currency_swap_4():
    ...
    print(f"{amount} {rate.split('/')[0]} equals {exchange_rates[rate] * amount:.2f} {rate.split('/')[1]}")
